  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'slide-out-to-top': 'slide-out-to-top 0.5s cubic-bezier(0.16, 1, 0.3, 1)',
        'slide-in-from-bottom': 'slide-in-from-bottom 0.5s cubic-bezier(0.16, 1, 0.3, 1)',
        'slide-out-to-bottom': 'slide-out-to-bottom 0.5s cubic-bezier(0.16, 1, 0.3, 1)',
        'slide-in-from-left': 'slide-in-from-left 0.5s cubic-bezier(0.16, 1, 0.3, 1)',
        'slide-out-to-left': 'slide-out-to-left 0.5s cubic-bezier(0.16, 1, 0.3, 1)',
        'slide-in-from-right': 'slide-in-from-right 0.5s cubic-bezier(0.16, 1, 0.3, 1)',
        'slide-out-to-right': 'slide-out-to-right 0.5s cubic-bezier(0.16, 1, 0.3, 1)',
      },
    },
  },
