...
export const AmberAlertClient = React.memo(function AmberAlertClient({ data }: { data: AlertGuideline }) {
          ...
          <AccordionTrigger className="p-6 text-left hover:no-underline">
            <div className="flex items-center gap-4 flex-1">
              ...
              <div className="flex-1 text-left">
                ...
                <CardDescription>Official FDLE standards for issuing an Amber Alert.</CardDescription>
              </div>
            </div>
          </AccordionTrigger>
              ...
              <div className="mt-6">
                <Button asChild>
                  <Link href="tel:1-888-356-4774">
                    ...
                    Initiate Amber Alert (Call FDLE)
                  </Link>
                </Button>
