...
export const rightsReferenceData: RightsInfo[] = [
  {
    ...
    officerTakeaway: 'Read this verbatim from your agency-issued card. Do not paraphrase. The key is "Custody + Interrogation = Miranda." A traffic stop is generally not custody. A voluntary interview at the station may not be custody. The moment a reasonable person would not feel free to leave, it becomes custody.',
  },
  {
    id: 'rights2',
  ...
  },
  {
    ...
    officerTakeaway: 'This applies to you as a unionized employee. If your supervisor calls you in for an interview that you think could result in discipline (e.g., regarding a citizen complaint), you have the right to have a union rep present. The employee must request it; it is not automatic.',
  },
  {
    id: 'rights4',
