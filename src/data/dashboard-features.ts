    ...
    features: [
      ...
      },
      {
      ...
      },
       {
        ...
        summary: "Find the closest relevant LE facilities and support centers.",
        icon: "MapPin",
    ...
    features: [
      {
        ...
        summary: "Transform field notes into professional report narratives.",
        icon: "ClipboardEdit",
      ...
      },
      {
        ...
        summary: "Get suggested charges based on your incident narrative.",
        icon: "Gavel",
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        title: "Report Writing Feedback",
        summary: "AI feedback on report clarity, objectivity, and completeness.",
        icon: "FileCheck",
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        summary: "Your rights during internal affairs investigations (F.S. 112.531).",
        icon: "ShieldCheck",
